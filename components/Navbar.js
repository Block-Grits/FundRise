      ...
      <div className='relative flex items-center justify-between'>
        ...
        <ul className='flex items-center hidden space-x-8 lg:flex'>
          ...
          {[
            ...
            { title: 'NFTs', link: '#' },
            { title: 'About us', link: '#' },
            { title: 'View Campaigns', link: '/details_page' },
            { title: 'Start a Campaign', link: '/create-campaign' },
          ].map((item, index) => (
            <NavBarItem
          ...
          <li>
            <p
              ...
              //   aria-label={
              //     props.walletConnected() ? 'Connected' : 'Connect Wallet'
              //   }
              //   title={props.walletConnected() ? 'Connected' : 'Connect Wallet'}
